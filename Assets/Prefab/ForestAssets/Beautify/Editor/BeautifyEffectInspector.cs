...
namespace BeautifyEffect {
				...
				public class BeautifyEffectInspector : Editor {
								...
								bool expandOutlineSection, expandSepiaSection, expandBlurSection;
								...
								SerializedProperty _anamorphicFlaresAntiflicker, _anamorphicFlaresUltra;
								SerializedProperty _sunFlares, _sun, _sunFlaresIntensity, _sunFlaresTint, _sunFlaresDownsampling, _sunFlaresSunIntensity, _sunFlaresSunDiskSize, _sunFlaresSunRayDiffractionIntensity;
								...
								SerializedProperty _depthOfField, _depthOfFieldTransparencySupport, _depthOfFieldExclusionLayerMask, _depthOfFieldDebug, _depthOfFieldAutofocus, _depthOfFieldAutofocusLayerMask;
								SerializedProperty _depthOfFieldTargetFocus, _depthOfFieldDistance, _depthOfFieldFocusSpeed, _depthOfFieldFocalLength, _depthOfFieldAperture, _depthOfFieldForegroundBlur;
								...
								SerializedProperty _vignetting, _vignettingColor, _vignettingCircularShape, _vignettingMask;
								SerializedProperty _frame, _frameColor, _frameMask;
								SerializedProperty _outline, _outlineColor, _outlineMode;
								SerializedProperty _sepia, _sepiaIntensity;
								...
								void OnEnable () {
												...
												expandSepiaSection = EditorPrefs.GetBool ("BeautifySepiaSection", false);
												...
												// Sepia
												_sepia = serializedObject.FindProperty ("_sepia");
												_sepiaIntensity = serializedObject.FindProperty ("_sepiaIntensity");
								...
								void OnDestroy () {
												...
												EditorPrefs.SetBool ("BeautifySepiaSection", expandSepiaSection);
...
//												#endif
            ...
            if (_effect.cameraEffect != null && !_effect.cameraEffect.allowHDR)
            {
												...
												if (_quality.intValue != (int)BEAUTIFY_QUALITY.Basic) {
																...
																if (testFeatureEnabled (isOutlineEnabled)) {
																				...
																				if (expandOutlineSection) {
																								...
																								EditorGUILayout.PropertyField (_outlineMode, new GUIContent ("   Mode", "Choose the outline algorithm. For 2D graphics, use Sobel."));
																				}
																} else {
																				EditorGUILayout.EndHorizontal ();
																}
																...
																if (testFeatureEnabled (isSepiaEnabled)) {
																				...
																				if (expandSepiaSection) {
																								EditorGUILayout.PropertyField (_sepiaIntensity, new GUIContent ("   Intensity")); // GUIContent.none);
																				}
																} else {
																				EditorGUILayout.EndHorizontal ();
																}
												...
												if (serializedObject.ApplyModifiedProperties () || (Event.current.type == EventType.ValidateCommand &&
																...
																_effect.UpdateMaterialProperties ();
